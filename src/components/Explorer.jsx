    ...
    <div className='explorer'>
      ...
      <Accordion animation={true} open={true} style={{marginTop: '8px', overflowX: 'scroll', flex: '1'}} title="OMER GAIZINGER">
        ...
        openIcon={<img className="folder-icon" alt='graduation-folder-open' src='/folders-icons/folder-graduate-open.png'/>} title="Education">
          ...
          <Accordion style={{paddingLeft: '8px'}} fit={true} icon={<img alt='academy-folder' className='folder-icon' src='/folders-icons/folder-core.svg'/>} 
          ...
          <Accordion style={{paddingLeft: '8px'}} fit={true} icon={<img alt='courses-folder' className='folder-icon' src='/folders-icons/folder-middleware.svg'/>} 
        ...
        <Accordion style={{paddingLeft: '8px', width: "100%"}} icon={<img alt='skills-folder' className='folder-icon' src='/folders-icons/folder-src.svg'/>} 
          ...
          <Accordion style={{paddingLeft: '8px'}} fit={true} icon={<img alt='resumes-folder' className='folder-icon' src='/folders-icons/folder-scripts.svg'/>} 
          ...
          <Accordion style={{paddingLeft: '8px'}} fit={true} icon={<img alt='experience-folder' className='folder-icon' src='/folders-icons/folder-resource.svg'/>} 
          ...
          <Accordion style={{paddingLeft: '8px'}} fit={true} icon={<img alt='projects-folder' className='folder-icon' src='/folders-icons/folder-github.svg'/>} 
